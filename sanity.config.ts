...
import linksPage from '@/sanity/schemaTypes/linksPage';
import linkCategory from '@/sanity/schemaTypes/linkCategory';
  ...
  S.list()
    ...
    .items([
      S.listItem()
        .title('Links Page')
        .id('linksPage')
        .icon(linksPage.icon) // Optional: use icon from schema
        .child(
          S.document()
